  ...
  useEffect(() => {
    ...
    const animate = (currentTime: number) => {
      ...
      if (!isDragging && container) {
        ...
        let speedMultiplier;
        if (scrollSpeed === 0.25) speedMultiplier = 0.6; // Lento: 60% de la velocidad base
        else if (scrollSpeed === 1) speedMultiplier = 2.5; // Rápido: 2.5 veces más rápido que normal
        else speedMultiplier = 1.5; // Normal: 50% más rápido que la velocidad base
    ...
    <div className="py-24 bg-[#2A2A2B]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-16">
          <h2 className="font-dorsa text-xl text-[#B3A269] font-semibold tracking-wide uppercase">
            Nuestras Cervezas
          </h2>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="font-dorsa text-4xl text-[#E5E1E6]">{product.name}</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div>
                      <h4 className="font-barlow-condensed text-lg text-[#B3A269] mb-2">Detalles</h4>
                    ...
                    <div>
                      <h4 className="font-barlow-condensed text-lg text-[#B3A269] mb-2">Maridaje</h4>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-dorsa text-3xl text-[#E5E1E6] mb-2">{product.name}</h3>
          ...
          <div className="mt-12 bg-[#222223] rounded-lg p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-3xl font-dorsa text-[#E5E1E6]">Tu Pack Personalizado</h3>
